package hmwk19.ms_robot.centerobjectdetect;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    int threshG = 0; // for gray detection threshold
    int threshB = 0; // for brightness threshold
    ...
    private void setMyControlListener() {
        myControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                threshG = progress; // update color detection threshold
            }
    ...
    private void setMyControl2Listener() {
        myControl2.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                progressChanged = progress;
                threshB = progress; // update color detection threshold
            }
...
//            for (int startY = 0; startY < bmp.getHeight(); startY++) {
            for (int startY = 0; startY < bmp.getHeight(); startY+=20) { // coarse, but maybe ok
                ...
                */
                ...
                for (int i = 0; i < bmp.getWidth(); i++) {
                    if (((green(pixels[i]) - red(pixels[i])) > -threshG)&&((green(pixels[i]) - red(pixels[i])) < threshG)&&(green(pixels[i])  > threshB)) {
...
//        canvas.drawText("pos = " + pos, 10, 200, paint1);
        ...
        mTextView.setText("FPS: " + String.valueOf(1000 / diff) + ", threshG: " + String.valueOf(threshG) + ", threshB: " + String.valueOf(threshB));
        prevtime = nowtime;
    }
}